 ...
 */
EAPI void evas_output_framespace_set(Eo *obj, Evas_Coord x, Evas_Coord y, Evas_Coord w, Evas_Coord h);
 ...
 */
EAPI void evas_output_framespace_get(const Eo *obj, Evas_Coord *x, Evas_Coord *y, Evas_Coord *w, Evas_Coord *h);
 ...
 */
EAPI void evas_output_viewport_set(Eo *obj, Evas_Coord x, Evas_Coord y, Evas_Coord w, Evas_Coord h);
 ...
 */
EAPI void evas_output_viewport_get(const Eo *obj, Evas_Coord *x, Evas_Coord *y, Evas_Coord *w, Evas_Coord *h);
 ...
 */
EAPI void evas_image_cache_set(Eo *obj, int size);
 ...
 *
 */
EAPI int evas_image_cache_get(const Eo *obj);
 ...
 */
EAPI void evas_event_default_flags_set(Eo *obj, Evas_Event_Flags flags);
 ...
 *
 */
EAPI Evas_Event_Flags evas_event_default_flags_get(const Eo *obj);
 ...
 */
EAPI void evas_output_method_set(Eo *obj, int render_method);
 ...
 *
 */
EAPI int evas_output_method_get(const Eo *obj);
 ...
 */
EAPI void evas_font_cache_set(Eo *obj, int size);
 ...
 *
 */
EAPI int evas_font_cache_get(const Eo *obj);
 ...
 * @param[in] h The height in output units, usually pixels.
 */
EAPI void evas_output_size_set(Eo *obj, int w, int h);
 ...
 * @param[out] h The height in output units, usually pixels.
 */
EAPI void evas_output_size_get(const Eo *obj, int *w, int *h);
 ...
 */
EAPI void evas_data_attach_set(Eo *obj, void *data);
 ...
 *
 */
EAPI void *evas_data_attach_get(const Eo *obj);
 ...
 */
EAPI void evas_font_hinting_set(Eo *obj, Evas_Font_Hinting_Flags hinting);
 ...
 *
 */
EAPI Evas_Font_Hinting_Flags evas_font_hinting_get(const Eo *obj);
 ...
 */
EAPI Eina_Bool evas_engine_info_set(Eo *obj, Evas_Engine_Info *info);
 ...
 *
 */
EAPI Evas_Engine_Info *evas_engine_info_get(const Eo *obj);
 ...
 *
 */
EAPI Evas_Object *evas_focus_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 *
 */
EAPI Evas_Object *evas_object_top_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 *
 */
EAPI const Evas_Lock *evas_key_lock_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI void evas_pointer_canvas_xy_get(const Eo *obj, Evas_Coord *x, Evas_Coord *y);
 ...
 *
 */
EAPI int evas_event_down_count_get(const Eo *obj);
 ...
 *
 */
EAPI int evas_smart_objects_calculate_count_get(const Eo *obj);
 ...
 *
 */
EAPI Eina_Bool evas_focus_state_get(const Eo *obj);
 ...
 *
 */
EAPI Eina_Bool evas_changed_get(const Eo *obj);
...
@ingroup Evas_Pointer_Group
 */
EAPI void evas_pointer_output_xy_get(const Eo *obj, int *x, int *y);
 ...
 *
 */
EAPI Eina_Bool evas_pointer_inside_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI Eina_Bool evas_image_max_size_get(const Eo *obj, int *maxw, int *maxh);
 ...
 *
 */
EAPI Evas_Object *evas_object_bottom_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 *
 */
EAPI const Evas_Modifier *evas_key_modifier_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 *
 */
EAPI int evas_pointer_button_down_mask_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI Eina_List *evas_tree_objects_at_xy_get(Eo *obj, Evas_Object *stop, int x, int y) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI void evas_event_feed_mouse_wheel(Eo *obj, int direction, int z, unsigned int timestamp, const void *data);
 ...
 */
EAPI void evas_key_lock_on(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 */
EAPI void evas_event_feed_key_down(Eo *obj, const char *keyname, const char *key, const char *string, const char *compose, unsigned int timestamp, const void *data);
 ...
 */
EAPI Evas_Modifier_Mask evas_key_modifier_mask_get(const Eo *obj, const char *keyname) EINA_WARN_UNUSED_RESULT EINA_ARG_NONNULL(2);
...
Evas modifiers.
 */
EAPI void evas_key_modifier_add(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 */
EAPI void evas_key_modifier_off(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @param[in] data The data for canvas.
 */
EAPI void evas_event_feed_hold(Eo *obj, int hold, unsigned int timestamp, const void *data);
 ...
 * @param[in] data The data for canvas.
 */
EAPI void evas_event_feed_mouse_move(Eo *obj, int x, int y, unsigned int timestamp, const void *data);
 ...
 * @param[in] data Data for canvas.
 */
EAPI void evas_event_feed_key_up(Eo *obj, const char *keyname, const char *key, const char *string, const char *compose, unsigned int timestamp, const void *data);
 ...
 * @param[in] data The data for canvas.
 */
EAPI void evas_event_feed_mouse_out(Eo *obj, unsigned int timestamp, const void *data);
 ...
 */
EAPI void evas_event_input_multi_move(Eo *obj, int d, int x, int y, double rad, double radx, double rady, double pres, double ang, double fx, double fy, unsigned int timestamp, const void *data);
 ...
 */
EAPI Eina_List *evas_objects_at_xy_get(const Eo *obj, Evas_Coord x, Evas_Coord y, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 * @param[in] data No description supplied.
 */
EAPI void evas_event_input_multi_up(Eo *obj, int d, int x, int y, double rad, double radx, double rady, double pres, double ang, double fx, double fy, Evas_Button_Flags flags, unsigned int timestamp, const void *data);
 ...
 * @param[in] data No description supplied.
 */
EAPI void evas_event_feed_multi_down(Eo *obj, int d, int x, int y, double rad, double radx, double rady, double pres, double ang, double fx, double fy, Evas_Button_Flags flags, unsigned int timestamp, const void *data);
 ...
 *
 */
EAPI Eina_Bool evas_render_async(Eo *obj);
 ...
 *
 */
EAPI void evas_focus_out(Eo *obj);
 ...
 * @param[in] data The data for canvas.
 */
EAPI void evas_event_input_mouse_move(Eo *obj, int x, int y, unsigned int timestamp, const void *data);
 ...
 *
 */
EAPI void evas_norender(Eo *obj);
 ...
 *
 */
EAPI unsigned int evas_touch_point_list_count(Eo *obj);
 ...
 * @param[in] data No description supplied.
 */
EAPI void evas_event_input_multi_down(Eo *obj, int d, int x, int y, double rad, double radx, double rady, double pres, double ang, double fx, double fy, Evas_Button_Flags flags, unsigned int timestamp, const void *data);
 ...
 *
 */
EAPI void evas_nochange_pop(Eo *obj);
 ...
 */
EAPI void evas_key_lock_off(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 *
 */
EAPI void evas_nochange_push(Eo *obj);
 ...
 *
 */
EAPI void evas_font_cache_flush(Eo *obj);
 ...
 * @param[in] hinting The hinting to use, one of #EVAS_FONT_HINTING_NONE,
 */
EAPI Eina_Bool evas_font_hinting_can_hint(const Eo *obj, Evas_Font_Hinting_Flags hinting) EINA_WARN_UNUSED_RESULT;
...
objects in this calculation
 */
EAPI Evas_Object *evas_object_top_at_xy_get(const Eo *obj, Evas_Coord x, Evas_Coord y, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI void evas_key_modifier_on(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @param[in] data The data for canvas.
 */
EAPI void evas_event_feed_mouse_up(Eo *obj, int b, Evas_Button_Flags flags, unsigned int timestamp, const void *data);
 ...
 * @param[in] data The data for canvas.
 */
EAPI void evas_event_feed_mouse_down(Eo *obj, int b, Evas_Button_Flags flags, unsigned int timestamp, const void *data);
 ...
 */
EAPI void evas_event_refeed_event(Eo *obj, void *event_copy, Evas_Callback_Type event_type);
 ...
 *
 */
EAPI Eina_List *evas_font_available_list(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI Eina_List *evas_objects_in_rectangle_get(const Eo *obj, Evas_Coord x, Evas_Coord y, Evas_Coord w, Evas_Coord h, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI Evas_Object *evas_object_name_find(const Eo *obj, const char *name) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI void evas_font_path_append(Eo *obj, const char *path) EINA_ARG_NONNULL(2);
 ...
 */
EAPI int evas_touch_point_list_nth_id_get(Eo *obj, unsigned int n);
 ...
 *
 */
EAPI void evas_font_path_clear(Eo *obj);
 ...
 * @param[out] y The pointer to a Evas_Coord to be filled in.
 */
EAPI void evas_touch_point_list_nth_xy_get(Eo *obj, unsigned int n, Evas_Coord *x, Evas_Coord *y);
 ...
 */
EAPI void evas_key_lock_del(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 */
EAPI void evas_damage_rectangle_add(Eo *obj, int x, int y, int w, int h);
 ...
 *
 */
EAPI const Eina_List *evas_font_path_list(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 *
 */
EAPI void evas_image_cache_reload(Eo *obj);
 ...
 */
EAPI int evas_coord_world_x_to_screen(const Eo *obj, Evas_Coord x) EINA_WARN_UNUSED_RESULT;
 ...
 * @param[in] data No description supplied.
 */
EAPI void evas_event_feed_multi_move(Eo *obj, int d, int x, int y, double rad, double radx, double rady, double pres, double ang, double fx, double fy, unsigned int timestamp, const void *data);
 ...
 *
 */
EAPI Eina_List *evas_render_updates(Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 *
 */
EAPI void evas_image_cache_flush(Eo *obj);
 ...
 */
EAPI Evas_Coord evas_coord_screen_y_to_world(const Eo *obj, int y) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI void evas_key_modifier_del(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @param[in] n The number of the touched point (0 being the first).
 */
EAPI Evas_Touch_Point_State evas_touch_point_list_nth_state_get(Eo *obj, unsigned int n);
 ...
 *
 */
EAPI void evas_focus_in(Eo *obj);
 ...
 * @param[in] h The rectangle's height.
 */
EAPI void evas_obscured_rectangle_add(Eo *obj, int x, int y, int w, int h);
 ...
 *
 */
EAPI void evas_render_dump(Eo *obj);
 ...
 * @param[in] data The data for canvas.
 */
EAPI void evas_event_feed_mouse_in(Eo *obj, unsigned int timestamp, const void *data);
...
objects in this calculation
 */
EAPI Evas_Object *evas_object_top_in_rectangle_get(const Eo *obj, Evas_Coord x, Evas_Coord y, Evas_Coord w, Evas_Coord h, Eina_Bool include_pass_events_objects, Eina_Bool include_hidden_objects) EINA_WARN_UNUSED_RESULT;
 ...
 * @param[in] data No description supplied.
 */
EAPI void evas_event_feed_multi_up(Eo *obj, int d, int x, int y, double rad, double radx, double rady, double pres, double ang, double fx, double fy, Evas_Button_Flags flags, unsigned int timestamp, const void *data);
 ...
 * @param[in] path The new font path.
 */
EAPI void evas_font_path_prepend(Eo *obj, const char *path) EINA_ARG_NONNULL(2);
 ...
 *
 */
EAPI void evas_obscured_clear(Eo *obj);
 ...
 * @param[in] data The data for canvas.
 */
EAPI void evas_event_feed_mouse_cancel(Eo *obj, unsigned int timestamp, const void *data);
 ...
 */
EAPI Evas_Coord evas_coord_screen_x_to_world(const Eo *obj, int x) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI void evas_key_lock_add(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 *
 */
EAPI void evas_render_idle_flush(Eo *obj);
 ...
 */
EAPI int evas_coord_world_y_to_screen(const Eo *obj, Evas_Coord y) EINA_WARN_UNUSED_RESULT;
 ...
 */
EAPI void evas_event_feed_key_down_with_keycode(Eo *obj, const char *keyname, const char *key, const char *string, const char *compose, unsigned int timestamp, const void *data, unsigned int keycode);
 ...
 * @param[in] keycode Key scan code numeric value for canvas.
 */
EAPI void evas_event_feed_key_up_with_keycode(Eo *obj, const char *keyname, const char *key, const char *string, const char *compose, unsigned int timestamp, const void *data, unsigned int keycode);
