 ...
 */
EAPI void evas_object_textgrid_supported_font_styles_set(Eo *obj, Evas_Textgrid_Font_Style styles);
 ...
 *
 */
EAPI Evas_Textgrid_Font_Style evas_object_textgrid_supported_font_styles_get(const Eo *obj);
 ...
 */
EAPI void evas_object_textgrid_size_set(Eo *obj, int w, int h);
 ...
 */
EAPI void evas_object_textgrid_size_get(const Eo *obj, int *w, int *h);
...
pixels of a cell.
 */
EAPI void evas_object_textgrid_cell_size_get(const Eo *obj, int *width, int *height);
 ...
 */
EAPI void evas_object_textgrid_update_add(Eo *obj, int x, int y, int w, int h);
 ...
 */
EAPI void evas_object_textgrid_cellrow_set(Eo *obj, int y, const Evas_Textgrid_Cell *row);
 ...
 * @param[in] y The row index of the grid.
 */
EAPI Evas_Textgrid_Cell *evas_object_textgrid_cellrow_get(const Eo *obj, int y);
 ...
 */
EAPI void evas_object_textgrid_palette_set(Eo *obj, Evas_Textgrid_Palette pal, int idx, int r, int g, int b, int a);
 ...
 */
EAPI void evas_object_textgrid_palette_get(const Eo *obj, Evas_Textgrid_Palette pal, int idx, int *r, int *g, int *b, int *a);
