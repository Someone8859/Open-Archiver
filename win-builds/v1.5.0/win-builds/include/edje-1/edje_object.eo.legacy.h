 ...
 */
EAPI void edje_object_update_hints_set(Eo *obj, Eina_Bool update);
 ...
 *
 */
EAPI Eina_Bool edje_object_update_hints_get(const Eo *obj);
 ...
 */
EAPI void edje_object_mirrored_set(Eo *obj, Eina_Bool rtl);
 ...
 *
 */
EAPI Eina_Bool edje_object_mirrored_get(const Eo *obj);
 ...
 */
EAPI void edje_object_animation_set(Eo *obj, Eina_Bool on);
 ...
 *
 */
EAPI Eina_Bool edje_object_animation_get(const Eo *obj);
 ...
 */
EAPI void edje_object_play_set(Eo *obj, Eina_Bool play);
 ...
 *
 */
EAPI Eina_Bool edje_object_play_get(const Eo *obj);
 ...
 */
EAPI void edje_object_perspective_set(Eo *obj, Edje_Perspective *ps);
 ...
 *
 */
EAPI const Edje_Perspective *edje_object_perspective_get(const Eo *obj);
 ...
 */
EAPI Eina_Bool edje_object_scale_set(Eo *obj, double scale);
 ...
 *
 */
EAPI double edje_object_scale_get(const Eo *obj);
 ...
 */
EAPI void edje_object_text_change_cb_set(Eo *obj, Edje_Text_Change_Cb func, void *data);
 ...
 */
EAPI void edje_object_part_text_cursor_begin_set(Eo *obj, const char *part, Edje_Cursor cur);
 ...
 * @param[in] cur the edje cursor to work on
 */
EAPI void edje_object_part_text_cursor_line_end_set(Eo *obj, const char *part, Edje_Cursor cur);
 ...
 */
EAPI Eina_Bool edje_object_text_class_set(Eo *obj, const char *text_class, const char *font, Evas_Font_Size size);
 ...
 */
EAPI Eina_Bool edje_object_part_text_cursor_coord_set(Eo *obj, const char *part, Edje_Cursor cur, Evas_Coord x, Evas_Coord y);
 ...
 * @param[in] cur the edje cursor to work on
 */
EAPI void edje_object_part_text_cursor_end_set(Eo *obj, const char *part, Edje_Cursor cur);
 ...
 */
EAPI Eina_Bool edje_object_part_text_escaped_set(Eo *obj, const char *part, const char *text);
 ...
 */
EAPI void edje_object_item_provider_set(Eo *obj, Edje_Item_Provider_Cb func, void *data);
 ...
 * @param[in] cur the edje cursor to work on
 */
EAPI void edje_object_part_text_cursor_line_begin_set(Eo *obj, const char *part, Edje_Cursor cur);
 ...
 */
EAPI void edje_object_message_handler_set(Eo *obj, Edje_Message_Handler_Cb func, void *data);
 ...
 */
EAPI void edje_object_size_min_get(const Eo *obj, Evas_Coord *minw, Evas_Coord *minh);
 ...
 *
 */
EAPI Eina_List *edje_object_access_part_list_get(const Eo *obj);
 ...
 *
 */
EAPI Edje_Load_Error edje_object_load_error_get(const Eo *obj);
 ...
 */
EAPI void edje_object_size_max_get(const Eo *obj, Evas_Coord *maxw, Evas_Coord *maxh);
 ...
 */
EAPI Eina_Bool edje_object_part_table_clear(Eo *obj, const char *part, Eina_Bool clear);
 ...
 */
EAPI Edje_External_Param_Type edje_object_part_external_param_type_get(const Eo *obj, const char *part, const char *param);
 ...
 */
EAPI void edje_object_part_text_select_allow_set(const Eo *obj, const char *part, Eina_Bool allow);
 ...
 */
EAPI const char *edje_object_part_state_get(const Eo *obj, const char *part, double *val_ret);
 ...
 */
EAPI void *edje_object_text_markup_filter_callback_del_full(Eo *obj, const char *part, Edje_Markup_Filter_Cb func, void *data);
 ...
 */
EAPI Eina_Bool edje_object_part_drag_step_set(Eo *obj, const char *part, double dx, double dy);
 ...
 */
EAPI Eina_Bool edje_object_part_drag_step_get(const Eo *obj, const char *part, double *dx, double *dy);
 ...
 * @param[in] part The part name
 */
EAPI void *edje_object_part_text_imf_context_get(const Eo *obj, const char *part);
 ...
 * @param[in] part The part name
 */
EAPI void edje_object_part_text_select_begin(const Eo *obj, const char *part);
 ...
 * @param[in] part The part name
 */
EAPI const char *edje_object_part_text_style_user_peek(const Eo *obj, const char *part);
 ...
 */
EAPI Eina_Bool edje_object_part_text_cursor_next(Eo *obj, const char *part, Edje_Cursor cur);
 ...
 */
EAPI void edje_object_part_text_style_user_push(Eo *obj, const char *part, const char *style);
 ...
 * @param[in] text The text string
 */
EAPI void edje_object_part_text_append(Eo *obj, const char *part, const char *text);
 ...
 */
EAPI Eina_Bool edje_object_part_geometry_get(const Eo *obj, const char *part, Evas_Coord *x, Evas_Coord *y, Evas_Coord *w, Evas_Coord *h);
 ...
 * @param[in] part The part name
 */
EAPI void edje_object_part_text_input_panel_hide(const Eo *obj, const char *part);
 ...
 */
EAPI Eina_Bool edje_object_part_text_item_geometry_get(const Eo *obj, const char *part, const char *item, Evas_Coord *cx, Evas_Coord *cy, Evas_Coord *cw, Evas_Coord *ch);
 ...
 */
EAPI Eina_Bool edje_object_part_table_unpack(Eo *obj, const char *part, Evas_Object *child_obj);
 ...
 * @param[in] part The part name
 */
EAPI void edje_object_part_text_select_abort(const Eo *obj, const char *part);
 ...
 * @param[in] data The data passed to the callback function
 */
EAPI void *edje_object_text_insert_filter_callback_del_full(Eo *obj, const char *part, Edje_Text_Filter_Cb func, void *data);
 ...
 * @param[in] part The part name
 */
EAPI void edje_object_part_text_style_user_pop(Eo *obj, const char *part);
 ...
 */
EAPI void edje_object_part_text_input_panel_imdata_set(Eo *obj, const char *part, const void *data, int len);
 ...
 */
EAPI void edje_object_part_text_input_panel_imdata_get(const Eo *obj, const char *part, void *data, int *len);
 ...
 * @param[in] text The text string
 */
EAPI void edje_object_part_text_insert(Eo *obj, const char *part, const char *text);
 ...
 */
EAPI Evas_Object *edje_object_part_box_remove_at(Eo *obj, const char *part, unsigned int pos);
 ...
 */
EAPI void edje_object_part_text_cursor_copy(Eo *obj, const char *part, Edje_Cursor src, Edje_Cursor dst);
...
height
 */
EAPI Eina_Bool edje_object_parts_extends_calc(Eo *obj, Evas_Coord *x, Evas_Coord *y, Evas_Coord *w, Evas_Coord *h);
 ...
 */
EAPI Eina_Bool edje_object_part_drag_value_set(Eo *obj, const char *part, double dx, double dy);
 ...
 */
EAPI Eina_Bool edje_object_part_drag_value_get(const Eo *obj, const char *part, double *dx, double *dy);
 ...
 *
 */
EAPI void edje_object_calc_force(Eo *obj);
 ...
 */
EAPI void edje_object_part_text_cursor_pos_set(Eo *obj, const char *part, Edje_Cursor cur, int pos);
 ...
 */
EAPI int edje_object_part_text_cursor_pos_get(const Eo *obj, const char *part, Edje_Cursor cur);
 ...
 *
 */
EAPI int edje_object_freeze(Eo *obj);
 ...
 */
EAPI char *edje_object_part_text_cursor_content_get(const Eo *obj, const char *part, Edje_Cursor cur);
 ...
 */
EAPI void edje_object_part_text_input_panel_layout_set(Eo *obj, const char *part, Edje_Input_Panel_Layout layout);
 ...
 * @param[in] part The part name
 */
EAPI Edje_Input_Panel_Layout edje_object_part_text_input_panel_layout_get(const Eo *obj, const char *part);
 ...
 */
EAPI Eina_Bool edje_object_part_table_pack(Eo *obj, const char *part, Evas_Object *child_obj, unsigned short col, unsigned short row, unsigned short colspan, unsigned short rowspan);
 ...
 */
EAPI void edje_object_part_text_input_panel_language_set(Eo *obj, const char *part, Edje_Input_Panel_Lang lang);
 ...
 * @param[in] part The part name
 */
EAPI Edje_Input_Panel_Lang edje_object_part_text_input_panel_language_get(const Eo *obj, const char *part);
 ...
 */
EAPI Eina_Bool edje_object_part_table_col_row_size_get(const Eo *obj, const char *part, int *cols, int *rows);
 ...
 * @param[in] part The part name
 */
EAPI Evas_Object *edje_object_part_external_object_get(const Eo *obj, const char *part);
 ...
 */
EAPI Evas_Object *edje_object_part_external_content_get(const Eo *obj, const char *part, const char *content);
 ...
 */
EAPI Eina_Bool edje_object_preload(Eo *obj, Eina_Bool cancel);
 ...
 */
EAPI void edje_object_part_text_input_panel_enabled_set(Eo *obj, const char *part, Eina_Bool enabled);
 ...
 * @param[in] part The part name
 */
EAPI Eina_Bool edje_object_part_text_input_panel_enabled_get(const Eo *obj, const char *part);
 ...
 * @param[in] part The part name
 */
EAPI void edje_object_part_text_select_extend(const Eo *obj, const char *part);
 ...
 */
EAPI Eina_Bool edje_object_part_box_insert_at(Eo *obj, const char *part, Evas_Object *child, unsigned int pos);
 ...
 */
EAPI const Eina_List *edje_object_part_text_anchor_geometry_get(const Eo *obj, const char *part, const char *anchor);
 ...
 * @param[in] cur the edje cursor to work on
 */
EAPI Eina_Bool edje_object_part_text_cursor_down(Eo *obj, const char *part, Edje_Cursor cur);
 ...
 */
EAPI Eina_Bool edje_object_part_drag_page_set(Eo *obj, const char *part, double dx, double dy);
 ...
 */
EAPI Eina_Bool edje_object_part_drag_page_get(const Eo *obj, const char *part, double *dx, double *dy);
 ...
 */
EAPI Eina_Bool edje_object_part_box_prepend(Eo *obj, const char *part, Evas_Object *child);
 ...
 */
EAPI void edje_object_signal_emit(Eo *obj, const char *emission, const char *source);
 ...
 */
EAPI void edje_object_part_text_input_panel_layout_variation_set(Eo *obj, const char *part, int variation);
 ...
 * @param[in] part The part name
 */
EAPI int edje_object_part_text_input_panel_layout_variation_get(const Eo *obj, const char *part);
 ...
 */
EAPI void edje_object_message_send(Eo *obj, Edje_Message_Type type, int id, void *msg);
 ...
 * @param[in] part The part name
 */
EAPI void edje_object_part_text_select_none(const Eo *obj, const char *part);
 ...
 * @param[in] part The Edje part's name
 */
EAPI const Evas_Object *edje_object_part_object_get(const Eo *obj, const char *part);
 ...
 */
EAPI Eina_Bool edje_object_part_drag_size_set(Eo *obj, const char *part, double dw, double dh);
 ...
 */
EAPI Eina_Bool edje_object_part_drag_size_get(const Eo *obj, const char *part, double *dw, double *dh);
 ...
 * @param[in] func The function callback to remove
 */
EAPI void *edje_object_text_insert_filter_callback_del(Eo *obj, const char *part, Edje_Text_Filter_Cb func);
 ...
 * @param[in] part The part name
 */
EAPI Edje_Drag_Dir edje_object_part_drag_dir_get(const Eo *obj, const char *part);
 ...
 */
EAPI Eina_Bool edje_object_part_text_unescaped_set(Eo *obj, const char *part, const char *text_to_escape);
 ...
 * @param[in] part The part name
 */
EAPI char *edje_object_part_text_unescaped_get(const Eo *obj, const char *part);
 ...
 */
EAPI void edje_object_signal_callback_add(Eo *obj, const char *emission, const char *source, Edje_Signal_Cb func, void *data);
 ...
 * @param[in] part The part name
 */
EAPI void edje_object_part_text_select_all(const Eo *obj, const char *part);
 ...
 */
EAPI void edje_object_part_text_input_panel_return_key_disabled_set(Eo *obj, const char *part, Eina_Bool disabled);
 ...
 * @param[in] part The part name
 */
EAPI Eina_Bool edje_object_part_text_input_panel_return_key_disabled_get(const Eo *obj, const char *part);
 ...
 */
EAPI void edje_object_part_text_autocapital_type_set(Eo *obj, const char *part, Edje_Text_Autocapital_Type autocapital_type);
 ...
 * @param[in] part The part name
 */
EAPI Edje_Text_Autocapital_Type edje_object_part_text_autocapital_type_get(const Eo *obj, const char *part);
 ...
 */
EAPI void edje_object_part_unswallow(Eo *obj, Evas_Object *obj_swallow);
 ...
 */
EAPI void edje_object_part_text_prediction_allow_set(Eo *obj, const char *part, Eina_Bool prediction);
 ...
 * @param[in] part The part name
 */
EAPI Eina_Bool edje_object_part_text_prediction_allow_get(const Eo *obj, const char *part);
 ...
 */
EAPI const char *edje_object_data_get(const Eo *obj, const char *key);
 ...
 */
EAPI void edje_object_text_markup_filter_callback_add(Eo *obj, const char *part, Edje_Markup_Filter_Cb func, void *data);
 ...
 *
 */
EAPI void edje_object_message_signal_process(Eo *obj);
 ...
 */
EAPI Evas_Object *edje_object_part_box_remove(Eo *obj, const char *part, Evas_Object *child);
 ...
 *
 */
EAPI int edje_object_thaw(Eo *obj);
 ...
 * @param[in] part The part name
 */
EAPI Evas_Object *edje_object_part_swallow_get(const Eo *obj, const char *part);
 ...
 * @param[in] part The part name
 */
EAPI void edje_object_part_text_imf_context_reset(const Eo *obj, const char *part);
 ...
 */
EAPI void edje_object_part_text_input_panel_return_key_type_set(Eo *obj, const char *part, Edje_Input_Panel_Return_Key_Type return_key_type);
 ...
 * @param[in] part The part name
 */
EAPI Edje_Input_Panel_Return_Key_Type edje_object_part_text_input_panel_return_key_type_get(const Eo *obj, const char *part);
 ...
 */
EAPI Evas_Object *edje_object_part_table_child_get(const Eo *obj, const char *part, unsigned int col, unsigned int row);
 ...
 */
EAPI Eina_Bool edje_object_part_box_insert_before(Eo *obj, const char *part, Evas_Object *child, const Evas_Object *reference);
...
returned.
 */
EAPI Eina_Bool edje_object_part_external_param_set(Eo *obj, const char *part, const Edje_External_Param *param);
...
returned.
 */
EAPI Eina_Bool edje_object_part_external_param_get(const Eo *obj, const char *part, Edje_External_Param *param);
...
required height
 */
EAPI void edje_object_size_min_calc(Eo *obj, Evas_Coord *minw, Evas_Coord *minh);
 ...
 */
EAPI Eina_Bool edje_object_part_box_append(Eo *obj, const char *part, Evas_Object *child);
 ...
 */
EAPI void edje_object_size_min_restricted_calc(Eo *obj, Evas_Coord *minw, Evas_Coord *minh, Evas_Coord restrictedw, Evas_Coord restrictedh);
 ...
 */
EAPI Eina_Bool edje_object_part_box_remove_all(Eo *obj, const char *part, Eina_Bool clear);
 ...
 */
EAPI Eina_Bool edje_object_part_drag_page(Eo *obj, const char *part, double dx, double dy);
 ...
 * @param[in] text The text string
 */
EAPI Eina_Bool edje_object_part_text_set(Eo *obj, const char *part, const char *text);
 ...
 * @param[in] part The part name
 */
EAPI const char *edje_object_part_text_get(const Eo *obj, const char *part);
 ...
 */
EAPI void edje_object_part_text_input_panel_show_on_demand_set(Eo *obj, const char *part, Eina_Bool ondemand);
 ...
 * @param[in] part The part name
 */
EAPI Eina_Bool edje_object_part_text_input_panel_show_on_demand_get(const Eo *obj, const char *part);
 ...
 * @param[in] part The part name
 */
EAPI const char *edje_object_part_text_selection_get(const Eo *obj, const char *part);
 ...
 * @param[in] cur The cursor to adjust.
 */
EAPI Eina_Bool edje_object_part_text_cursor_is_format_get(const Eo *obj, const char *part, Edje_Cursor cur);
 ...
 */
EAPI Eina_Bool edje_object_color_class_set(Eo *obj, const char *color_class, int r, int g, int b, int a, int r2, int g2, int b2, int a2, int r3, int g3, int b3, int a3);
 ...
 */
EAPI Eina_Bool edje_object_color_class_get(const Eo *obj, const char *color_class, int *r, int *g, int *b, int *a, int *r2, int *g2, int *b2, int *a2, int *r3, int *g3, int *b3, int *a3);
 ...
 * @param[in] dy The y step
 */
EAPI Eina_Bool edje_object_part_drag_step(Eo *obj, const char *part, double dx, double dy);
 ...
 * @param[in] cur the edje cursor to work on
 */
EAPI Eina_Bool edje_object_part_text_cursor_up(Eo *obj, const char *part, Edje_Cursor cur);
 ...
 */
EAPI void edje_object_part_text_cursor_geometry_get(const Eo *obj, const char *part, Evas_Coord *x, Evas_Coord *y, Evas_Coord *w, Evas_Coord *h);
 ...
 * @param[in] part The part name
 */
EAPI const Eina_List *edje_object_part_text_anchor_list_get(const Eo *obj, const char *part);
 ...
 * @param[in] data User provided data to pass to the filter function
 */
EAPI void edje_object_text_insert_filter_callback_add(Eo *obj, const char *part, Edje_Text_Filter_Cb func, void *data);
 ...
 * @param[in] part The part name
 */
EAPI void edje_object_part_text_input_panel_show(const Eo *obj, const char *part);
...
group
 */
EAPI Eina_Bool edje_object_part_exists(const Eo *obj, const char *part);
 ...
 * @param[in] func The function callback to remove
 */
EAPI void *edje_object_text_markup_filter_callback_del(Eo *obj, const char *part, Edje_Markup_Filter_Cb func);
 ...
 * @param[in] cur The cursor to adjust.
 */
EAPI Eina_Bool edje_object_part_text_cursor_is_visible_format_get(const Eo *obj, const char *part, Edje_Cursor cur);
 ...
 * @param[in] text The text string
 */
EAPI void edje_object_part_text_user_insert(const Eo *obj, const char *part, const char *text);
 ...
 * @param[in] cur the edje cursor to work on
 */
EAPI Eina_Bool edje_object_part_text_cursor_prev(Eo *obj, const char *part, Edje_Cursor cur);
 ...
 * @param[in] part The part name
 */
EAPI const Eina_List *edje_object_part_text_item_list_get(const Eo *obj, const char *part);
 ...
 */
EAPI Eina_Bool edje_object_part_swallow(Eo *obj, const char *part, Evas_Object *obj_swallow);
