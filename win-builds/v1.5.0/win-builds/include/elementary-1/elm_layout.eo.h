...
const Eo_Class *elm_layout_class_get(void) EINA_CONST;
 ...
 *
 */
EOAPI Eina_Bool  elm_obj_layout_file_set(const char *file, const char *group);
...
EOAPI extern const Eo_Event_Description _ELM_LAYOUT_EVENT_FOCUSED;
EOAPI extern const Eo_Event_Description _ELM_LAYOUT_EVENT_UNFOCUSED;
 ...
 * No description
 */
#define ELM_LAYOUT_EVENT_FOCUSED (&(_ELM_LAYOUT_EVENT_FOCUSED))

/**
 * No description
 */
#define ELM_LAYOUT_EVENT_UNFOCUSED (&(_ELM_LAYOUT_EVENT_UNFOCUSED))
