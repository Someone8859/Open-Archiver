...
const Eo_Class *elm_photocam_class_get(void) EINA_CONST;
 ...
 *
 */
EOAPI Evas_Load_Error  elm_obj_photocam_file_set(const char *file);
 ...
 *
 */
EOAPI const char * elm_obj_photocam_file_get(void);
...
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_CLICKED;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_PRESS;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_LONGPRESSED;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_CLICKED_DOUBLE;
...
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_ZOOM_START;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_ZOOM_STOP;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_ZOOM_CHANGE;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_SCROLL;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_SCROLL_ANIM_START;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_SCROLL_ANIM_STOP;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_SCROLL_DRAG_START;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_SCROLL_DRAG_STOP;
...
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_FOCUSED;
EOAPI extern const Eo_Event_Description _ELM_PHOTOCAM_EVENT_UNFOCUSED;

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_CLICKED (&(_ELM_PHOTOCAM_EVENT_CLICKED))
 ...
 * No description
 */
#define ELM_PHOTOCAM_EVENT_LONGPRESSED (&(_ELM_PHOTOCAM_EVENT_LONGPRESSED))

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_CLICKED_DOUBLE (&(_ELM_PHOTOCAM_EVENT_CLICKED_DOUBLE))
 ...
 * No description
 */
#define ELM_PHOTOCAM_EVENT_ZOOM_START (&(_ELM_PHOTOCAM_EVENT_ZOOM_START))

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_ZOOM_STOP (&(_ELM_PHOTOCAM_EVENT_ZOOM_STOP))

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_ZOOM_CHANGE (&(_ELM_PHOTOCAM_EVENT_ZOOM_CHANGE))

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_SCROLL (&(_ELM_PHOTOCAM_EVENT_SCROLL))

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_SCROLL_ANIM_START (&(_ELM_PHOTOCAM_EVENT_SCROLL_ANIM_START))

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_SCROLL_ANIM_STOP (&(_ELM_PHOTOCAM_EVENT_SCROLL_ANIM_STOP))

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_SCROLL_DRAG_START (&(_ELM_PHOTOCAM_EVENT_SCROLL_DRAG_START))

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_SCROLL_DRAG_STOP (&(_ELM_PHOTOCAM_EVENT_SCROLL_DRAG_STOP))
 ...
 * No description
 */
#define ELM_PHOTOCAM_EVENT_FOCUSED (&(_ELM_PHOTOCAM_EVENT_FOCUSED))

/**
 * No description
 */
#define ELM_PHOTOCAM_EVENT_UNFOCUSED (&(_ELM_PHOTOCAM_EVENT_UNFOCUSED))
