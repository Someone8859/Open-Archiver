 ...
 */
EAPI void elm_flip_interaction_direction_hitsize_set(Eo *obj, Elm_Flip_Direction dir, double hitsize);
 ...
 */
EAPI double elm_flip_interaction_direction_hitsize_get(Eo *obj, Elm_Flip_Direction dir);
 ...
 */
EAPI void elm_flip_interaction_direction_enabled_set(Eo *obj, Elm_Flip_Direction dir, Eina_Bool enabled);
 ...
 * @param[in] dir The direction to check
 */
EAPI Eina_Bool elm_flip_interaction_direction_enabled_get(Eo *obj, Elm_Flip_Direction dir);
