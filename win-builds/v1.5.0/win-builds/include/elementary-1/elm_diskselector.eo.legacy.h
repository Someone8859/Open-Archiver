 ...
 */
EAPI void elm_diskselector_side_text_max_length_set(Eo *obj, int len);
 ...
 *
 */
EAPI int elm_diskselector_side_text_max_length_get(const Eo *obj);
...
disable it.
 */
EAPI void elm_diskselector_round_enabled_set(Eo *obj, Eina_Bool enabled);
 ...
 *
 */
EAPI Eina_Bool elm_diskselector_round_enabled_get(const Eo *obj);
 ...
 */
EAPI void elm_diskselector_display_item_num_set(Eo *obj, int num);
 ...
 *
 */
EAPI int elm_diskselector_display_item_num_get(const Eo *obj);
 ...
 *
 */
EAPI Elm_Object_Item *elm_diskselector_first_item_get(const Eo *obj);
 ...
 *
 */
EAPI const Eina_List *elm_diskselector_items_get(const Eo *obj);
 ...
 *
 */
EAPI Elm_Object_Item *elm_diskselector_last_item_get(const Eo *obj);
 ...
 *
 */
EAPI Elm_Object_Item *elm_diskselector_selected_item_get(const Eo *obj);
 ...
 */
EAPI Elm_Object_Item *elm_diskselector_item_append(Eo *obj, const char *label, Evas_Object *icon, Evas_Smart_Cb func, const void *data);
 ...
 *
 */
EAPI void elm_diskselector_clear(Eo *obj);
