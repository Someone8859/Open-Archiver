#ifndef _ELC_FILESELECTOR_ENTRY_EO_H_
#define _ELC_FILESELECTOR_ENTRY_EO_H_

#ifndef _ELC_FILESELECTOR_ENTRY_EO_TYPES
#define _ELC_FILESELECTOR_ENTRY_EO_TYPES


#endif
#define ELM_FILESELECTOR_ENTRY_CLASS elm_fileselector_entry_class_get()

const Eo_Class *elm_fileselector_entry_class_get(void) EINA_CONST;
