 ...
 */
EAPI Eina_Bool elm_layout_theme_set(Eo *obj, const char *klass, const char *group, const char *style);
 ...
 */
EAPI Eina_Bool elm_layout_part_cursor_engine_only_set(Eo *obj, const char *part_name, Eina_Bool engine_only);
 ...
 * @param[in] part_name a part from loaded edje group.
 */
EAPI Eina_Bool elm_layout_part_cursor_engine_only_get(const Eo *obj, const char *part_name);
 ...
 *
 */
EAPI int elm_layout_freeze(Eo *obj);
 ...
 *
 */
EAPI void elm_layout_sizing_eval(Eo *obj);
 ...
 */
EAPI void elm_layout_sizing_restricted_eval(Eo *obj, Eina_Bool width, Eina_Bool height);
 ...
 */
EAPI Eina_Bool elm_layout_part_cursor_style_set(Eo *obj, const char *part_name, const char *style);
 ...
 * @param[in] part_name a part from loaded edje group.
 */
EAPI const char *elm_layout_part_cursor_style_get(const Eo *obj, const char *part_name);
 ...
 */
EAPI const char *elm_layout_text_get(const Eo *obj, const char *part);
 ...
 */
EAPI Eina_Bool elm_layout_part_cursor_set(Eo *obj, const char *part_name, const char *cursor);
 ...
 * @param[in] part_name a part from loaded edje group.
 */
EAPI const char *elm_layout_part_cursor_get(const Eo *obj, const char *part_name);
 ...
 */
EAPI const char *elm_layout_data_get(const Eo *obj, const char *key);
 ...
 *
 */
EAPI int elm_layout_thaw(Eo *obj);
 ...
 */
EAPI Eina_Bool elm_layout_part_cursor_unset(Eo *obj, const char *part_name);
