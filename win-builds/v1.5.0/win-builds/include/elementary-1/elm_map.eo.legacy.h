 ...
 */
EAPI void elm_map_zoom_set(Eo *obj, int zoom);
 ...
 *
 */
EAPI int elm_map_zoom_get(const Eo *obj);
...
to unpause it.
 */
EAPI void elm_map_paused_set(Eo *obj, Eina_Bool paused);
 ...
 *
 */
EAPI Eina_Bool elm_map_paused_get(const Eo *obj);
...
to enable it.
 */
EAPI void elm_map_wheel_disabled_set(Eo *obj, Eina_Bool disabled);
 ...
 *
 */
EAPI Eina_Bool elm_map_wheel_disabled_get(const Eo *obj);
 ...
 */
EAPI void elm_map_zoom_min_set(Eo *obj, int zoom);
 ...
 *
 */
EAPI int elm_map_zoom_min_get(const Eo *obj);
 ...
 */
EAPI void elm_map_rotate_set(Eo *obj, double degree, Evas_Coord cx, Evas_Coord cy);
 ...
 */
EAPI void elm_map_rotate_get(const Eo *obj, double *degree, Evas_Coord *cx, Evas_Coord *cy);
 ...
 */
EAPI void elm_map_user_agent_set(Eo *obj, const char *user_agent);
 ...
 *
 */
EAPI const char *elm_map_user_agent_get(const Eo *obj);
 ...
 */
EAPI void elm_map_zoom_max_set(Eo *obj, int zoom);
 ...
 *
 */
EAPI int elm_map_zoom_max_get(const Eo *obj);
 ...
 */
EAPI void elm_map_zoom_mode_set(Eo *obj, Elm_Map_Zoom_Mode mode);
 ...
 *
 */
EAPI Elm_Map_Zoom_Mode elm_map_zoom_mode_get(const Eo *obj);
 ...
 */
EAPI void elm_map_region_get(const Eo *obj, double *lon, double *lat);
 ...
 *
 */
EAPI Eina_List *elm_map_overlays_get(const Eo *obj);
 ...
 */
EAPI void elm_map_tile_load_status_get(const Eo *obj, int *try_num, int *finish_num);
 ...
 */
EAPI void elm_map_source_set(Eo *obj, Elm_Map_Source_Type type, const char *source_name);
 ...
 * @param[in] type source type.
 */
EAPI const char *elm_map_source_get(const Eo *obj, Elm_Map_Source_Type type);
 ...
 */
EAPI Elm_Map_Route *elm_map_route_add(Eo *obj, Elm_Map_Route_Type type, Elm_Map_Route_Method method, double flon, double flat, double tlon, double tlat, Elm_Map_Route_Cb route_cb, void *data);
 ...
 */
EAPI Evas_Object *elm_map_track_add(Eo *obj, void *emap);
 ...
 */
EAPI void elm_map_region_to_canvas_convert(const Eo *obj, double lon, double lat, Evas_Coord *x, Evas_Coord *y);
 ...
 */
EAPI Elm_Map_Overlay *elm_map_overlay_circle_add(Eo *obj, double lon, double lat, double radius);
 ...
 *
 */
EAPI Elm_Map_Overlay *elm_map_overlay_class_add(Eo *obj);
 ...
 *
 */
EAPI Elm_Map_Overlay *elm_map_overlay_bubble_add(Eo *obj);
 ...
 * @param[in] type source type.
 */
EAPI const char **elm_map_sources_get(const Eo *obj, Elm_Map_Source_Type type);
 ...
 *
 */
EAPI Elm_Map_Overlay *elm_map_overlay_polygon_add(Eo *obj);
 ...
 * @param[in] tlat The destination latitude.
 */
EAPI Elm_Map_Overlay *elm_map_overlay_line_add(Eo *obj, double flon, double flat, double tlon, double tlat);
 ...
 */
EAPI void elm_map_region_show(Eo *obj, double lon, double lat);
 ...
 */
EAPI Elm_Map_Name *elm_map_name_add(const Eo *obj, const char *address, double lon, double lat, Elm_Map_Name_Cb name_cb, void *data);
 ...
 * @param[in] data The user callback data.
 */
EAPI void elm_map_name_search(const Eo *obj, const char *address, Elm_Map_Name_List_Cb name_cb, void *data);
 ...
 * @param[in] lat Latitude to center at.
 */
EAPI void elm_map_region_bring_in(Eo *obj, double lon, double lat);
 ...
 * @param[in] lat Latitude to center at.
 */
EAPI void elm_map_region_zoom_bring_in(Eo *obj, int zoom, double lon, double lat);
 ...
 */
EAPI void elm_map_track_remove(Eo *obj, Evas_Object *route);
 ...
 */
EAPI Elm_Map_Overlay *elm_map_overlay_route_add(Eo *obj, const Elm_Map_Route *route);
 ...
 */
EAPI Elm_Map_Overlay *elm_map_overlay_scale_add(Eo *obj, Evas_Coord x, Evas_Coord y);
 ...
 */
EAPI Elm_Map_Overlay *elm_map_overlay_add(Eo *obj, double lon, double lat);
 ...
 */
EAPI void elm_map_canvas_to_region_convert(const Eo *obj, Evas_Coord x, Evas_Coord y, double *lon, double *lat);
