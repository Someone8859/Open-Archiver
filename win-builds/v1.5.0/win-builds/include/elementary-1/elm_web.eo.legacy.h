 ...
 */
EAPI Eina_Bool elm_web_text_matches_highlight_set(Eo *obj, Eina_Bool highlight);
 ...
 *
 */
EAPI Eina_Bool elm_web_text_matches_highlight_get(const Eo *obj);
 ...
 */
EAPI void elm_web_useragent_set(Eo *obj, const char *user_agent);
 ...
 *
 */
EAPI const char *elm_web_useragent_get(const Eo *obj);
 ...
 */
EAPI Eina_Bool elm_web_url_set(Eo *obj, const char *url);
 ...
 *
 */
EAPI const char *elm_web_url_get(const Eo *obj);
 ...
 */
EAPI void elm_web_bg_color_set(Eo *obj, int r, int g, int b, int a);
 ...
 */
EAPI void elm_web_bg_color_get(const Eo *obj, int *r, int *g, int *b, int *a);
 ...
 */
EAPI void elm_web_inwin_mode_set(Eo *obj, Eina_Bool value);
 ...
 *
 */
EAPI Eina_Bool elm_web_inwin_mode_get(const Eo *obj);
 ...
 */
EAPI void elm_web_tab_propagate_set(Eo *obj, Eina_Bool propagate);
 ...
 *
 */
EAPI Eina_Bool elm_web_tab_propagate_get(const Eo *obj);
 ...
 */
EAPI void elm_web_history_enabled_set(Eo *obj, Eina_Bool enable);
 ...
 *
 */
EAPI Eina_Bool elm_web_history_enabled_get(const Eo *obj);
 ...
 */
EAPI void elm_web_zoom_mode_set(Eo *obj, Elm_Web_Zoom_Mode mode);
 ...
 *
 */
EAPI Elm_Web_Zoom_Mode elm_web_zoom_mode_get(const Eo *obj);
 ...
 */
EAPI void elm_web_zoom_set(Eo *obj, double zoom);
 ...
 *
 */
EAPI double elm_web_zoom_get(const Eo *obj);
 ...
 */
EAPI void elm_web_console_message_hook_set(Eo *obj, Elm_Web_Console_Message func, void *data);
 ...
 * @param[in] data User data
 */
EAPI void elm_web_window_create_hook_set(Eo *obj, Elm_Web_Window_Open func, void *data);
 ...
 * @param[in] data User data
 */
EAPI void elm_web_dialog_file_selector_hook_set(Eo *obj, Elm_Web_Dialog_File_Selector func, void *data);
 ...
 * @param[in] data User data
 */
EAPI void elm_web_dialog_confirm_hook_set(Eo *obj, Elm_Web_Dialog_Confirm func, void *data);
 ...
 */
EAPI void elm_web_popup_selected_set(Eo *obj, int idx);
 ...
 * @param[in] data User data
 */
EAPI void elm_web_dialog_prompt_hook_set(Eo *obj, Elm_Web_Dialog_Prompt func, void *data);
 ...
 * @param[in] data User data
 */
EAPI void elm_web_dialog_alert_hook_set(Eo *obj, Elm_Web_Dialog_Alert func, void *data);
 ...
 *
 */
EAPI Eina_Bool elm_web_forward_possible_get(const Eo *obj);
 ...
 *
 */
EAPI Evas_Object *elm_web_webkit_view_get(const Eo *obj);
 ...
 *
 */
EAPI Eina_Bool elm_web_back_possible_get(const Eo *obj);
 ...
 *
 */
EAPI double elm_web_load_progress_get(const Eo *obj);
 ...
 *
 */
EAPI const char *elm_web_selection_get(const Eo *obj);
 ...
 *
 */
EAPI const char *elm_web_title_get(const Eo *obj);
 ...
 */
EAPI Eina_Bool elm_web_navigate(Eo *obj, int steps);
 ...
 *
 */
EAPI Eina_Bool elm_web_back(Eo *obj);
 ...
 */
EAPI Eina_Bool elm_web_html_string_load(Eo *obj, const char *html, const char *base_url, const char *unreachable_url);
 ...
 */
EAPI Eina_Bool elm_web_text_search(const Eo *obj, const char *string, Eina_Bool case_sensitive, Eina_Bool forward, Eina_Bool wrap);
 ...
 *
 */
EAPI Eina_Bool elm_web_popup_destroy(Eo *obj);
 ...
 */
EAPI void elm_web_region_show(Eo *obj, int x, int y, int w, int h);
 ...
 *
 */
EAPI Eina_Bool elm_web_forward(Eo *obj);
 ...
 */
EAPI unsigned int elm_web_text_matches_mark(Eo *obj, const char *string, Eina_Bool case_sensitive, Eina_Bool highlight, unsigned int limit);
 ...
 * @param[in] h The height of the region to show
 */
EAPI void elm_web_region_bring_in(Eo *obj, int x, int y, int w, int h);
 ...
 *
 */
EAPI Eina_Bool elm_web_stop(Eo *obj);
 ...
 */
EAPI Eina_Bool elm_web_navigate_possible_get(Eo *obj, int steps);
 ...
 *
 */
EAPI Eina_Bool elm_web_reload_full(Eo *obj);
 ...
 *
 */
EAPI Eina_Bool elm_web_text_matches_unmark_all(Eo *obj);
 ...
 *
 */
EAPI Eina_Bool elm_web_reload(Eo *obj);
