...
const Eo_Class *elm_index_class_get(void) EINA_CONST;
...
EOAPI extern const Eo_Event_Description _ELM_INDEX_EVENT_SELECTED;
...
EOAPI extern const Eo_Event_Description _ELM_INDEX_EVENT_FOCUSED;
EOAPI extern const Eo_Event_Description _ELM_INDEX_EVENT_UNFOCUSED;
 ...
 * No description
 */
#define ELM_INDEX_EVENT_SELECTED (&(_ELM_INDEX_EVENT_SELECTED))
 ...
 * No description
 */
#define ELM_INDEX_EVENT_FOCUSED (&(_ELM_INDEX_EVENT_FOCUSED))

/**
 * No description
 */
#define ELM_INDEX_EVENT_UNFOCUSED (&(_ELM_INDEX_EVENT_UNFOCUSED))
