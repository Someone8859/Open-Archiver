...
..., Saturday = 6)
 */
EAPI void elm_calendar_first_day_of_week_set(Eo *obj, Elm_Calendar_Weekday day);
 ...
 *
 */
EAPI Elm_Calendar_Weekday elm_calendar_first_day_of_week_get(const Eo *obj);
 ...
 */
EAPI void elm_calendar_selectable_set(Eo *obj, Elm_Calendar_Selectable selectable);
 ...
 *
 */
EAPI Elm_Calendar_Selectable elm_calendar_selectable_get(const Eo *obj);
 ...
 */
EAPI void elm_calendar_interval_set(Eo *obj, double interval);
 ...
 *
 */
EAPI double elm_calendar_interval_get(const Eo *obj);
 ...
 */
EAPI void elm_calendar_weekdays_names_set(Eo *obj, const char **weekdays);
 ...
 *
 */
EAPI const char **elm_calendar_weekdays_names_get(const Eo *obj);
 ...
 */
EAPI void elm_calendar_select_mode_set(Eo *obj, Elm_Calendar_Select_Mode mode);
 ...
 *
 */
EAPI Elm_Calendar_Select_Mode elm_calendar_select_mode_get(const Eo *obj);
 ...
 */
EAPI void elm_calendar_min_max_year_set(Eo *obj, int min, int max);
 ...
 */
EAPI void elm_calendar_min_max_year_get(const Eo *obj, int *min, int *max);
...
the selected date
 */
EAPI void elm_calendar_format_function_set(Eo *obj, Elm_Calendar_Format_Cb format_function);
 ...
 *
 */
EAPI const Eina_List *elm_calendar_marks_get(const Eo *obj);
 ...
 */
EAPI void elm_calendar_selected_time_set(Eo *obj, struct tm *selected_time);
 ...
 */
EAPI Eina_Bool elm_calendar_selected_time_get(const Eo *obj, struct tm *selected_time);
 ...
 */
EAPI Elm_Calendar_Mark *elm_calendar_mark_add(Eo *obj, const char *mark_type, struct tm *mark_time, Elm_Calendar_Mark_Repeat_Type repeat);
 ...
 *
 */
EAPI void elm_calendar_marks_clear(Eo *obj);
 ...
 *
 */
EAPI void elm_calendar_marks_draw(Eo *obj);
 ...
 */
EAPI Eina_Bool elm_calendar_displayed_time_get(const Eo *obj, struct tm *displayed_time);
