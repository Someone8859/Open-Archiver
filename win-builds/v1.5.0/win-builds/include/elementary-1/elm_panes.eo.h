...
const Eo_Class *elm_panes_class_get(void) EINA_CONST;
...
EOAPI extern const Eo_Event_Description _ELM_PANES_EVENT_CLICKED;
...
EOAPI extern const Eo_Event_Description _ELM_PANES_EVENT_CLICKED_DOUBLE;

/**
 * No description
 */
#define ELM_PANES_EVENT_CLICKED (&(_ELM_PANES_EVENT_CLICKED))
 ...
 * No description
 */
#define ELM_PANES_EVENT_CLICKED_DOUBLE (&(_ELM_PANES_EVENT_CLICKED_DOUBLE))
