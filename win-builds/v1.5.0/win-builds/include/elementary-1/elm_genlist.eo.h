...
const Eo_Class *elm_genlist_class_get(void) EINA_CONST;
...
EOAPI extern const Eo_Event_Description _ELM_GENLIST_EVENT_FOCUSED;
EOAPI extern const Eo_Event_Description _ELM_GENLIST_EVENT_UNFOCUSED;
 ...
 * No description
 */
#define ELM_GENLIST_EVENT_FOCUSED (&(_ELM_GENLIST_EVENT_FOCUSED))

/**
 * No description
 */
#define ELM_GENLIST_EVENT_UNFOCUSED (&(_ELM_GENLIST_EVENT_UNFOCUSED))
