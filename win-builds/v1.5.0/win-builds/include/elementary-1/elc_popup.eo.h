#ifndef _ELC_POPUP_EO_H_
#define _ELC_POPUP_EO_H_

#ifndef _ELC_POPUP_EO_TYPES
#define _ELC_POPUP_EO_TYPES


#endif
#define ELM_POPUP_CLASS elm_popup_class_get()

const Eo_Class *elm_popup_class_get(void) EINA_CONST;
...
EOAPI extern const Eo_Event_Description _ELM_POPUP_EVENT_FOCUSED;
EOAPI extern const Eo_Event_Description _ELM_POPUP_EVENT_UNFOCUSED;
 ...
 * No description
 */
#define ELM_POPUP_EVENT_FOCUSED (&(_ELM_POPUP_EVENT_FOCUSED))

/**
 * No description
 */
#define ELM_POPUP_EVENT_UNFOCUSED (&(_ELM_POPUP_EVENT_UNFOCUSED))
