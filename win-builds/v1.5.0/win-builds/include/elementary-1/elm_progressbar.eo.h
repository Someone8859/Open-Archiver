...
const Eo_Class *elm_progressbar_class_get(void) EINA_CONST;
...
EOAPI extern const Eo_Event_Description _ELM_PROGRESSBAR_EVENT_FOCUSED;
EOAPI extern const Eo_Event_Description _ELM_PROGRESSBAR_EVENT_UNFOCUSED;
 ...
 * No description
 */
#define ELM_PROGRESSBAR_EVENT_FOCUSED (&(_ELM_PROGRESSBAR_EVENT_FOCUSED))

/**
 * No description
 */
#define ELM_PROGRESSBAR_EVENT_UNFOCUSED (&(_ELM_PROGRESSBAR_EVENT_UNFOCUSED))
