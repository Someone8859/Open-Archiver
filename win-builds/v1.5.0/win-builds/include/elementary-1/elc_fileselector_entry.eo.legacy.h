#ifndef _ELC_FILESELECTOR_ENTRY_EO_LEGACY_H_
#define _ELC_FILESELECTOR_ENTRY_EO_LEGACY_H_
 ...
 */
EAPI void elm_fileselector_entry_inwin_mode_set(Eo *obj, Eina_Bool value);
 ...
 *
 */
EAPI Eina_Bool elm_fileselector_entry_inwin_mode_get(const Eo *obj);
 ...
 */
EAPI void elm_fileselector_entry_window_size_set(Eo *obj, Evas_Coord width, Evas_Coord height);
 ...
 */
EAPI void elm_fileselector_entry_window_size_get(const Eo *obj, Evas_Coord *width, Evas_Coord *height);
 ...
 */
EAPI void elm_fileselector_entry_window_title_set(Eo *obj, const char *title);
 ...
 *
 */
EAPI const char *elm_fileselector_entry_window_title_get(const Eo *obj);
