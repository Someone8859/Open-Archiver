 ...
 */
EAPI void elm_index_autohide_disabled_set(Eo *obj, Eina_Bool disabled);
 ...
 *
 */
EAPI Eina_Bool elm_index_autohide_disabled_get(const Eo *obj);
 ...
 */
EAPI void elm_index_omit_enabled_set(Eo *obj, Eina_Bool enabled);
 ...
 *
 */
EAPI Eina_Bool elm_index_omit_enabled_get(const Eo *obj);
 ...
 */
EAPI void elm_index_horizontal_set(Eo *obj, Eina_Bool horizontal);
 ...
 *
 */
EAPI Eina_Bool elm_index_horizontal_get(const Eo *obj);
 ...
 */
EAPI void elm_index_delay_change_time_set(Eo *obj, double dtime);
 ...
 *
 */
EAPI double elm_index_delay_change_time_get(const Eo *obj);
 ...
 */
EAPI void elm_index_indicator_disabled_set(Eo *obj, Eina_Bool disabled);
 ...
 *
 */
EAPI Eina_Bool elm_index_indicator_disabled_get(const Eo *obj);
 ...
 */
EAPI void elm_index_item_level_set(Eo *obj, int level);
 ...
 *
 */
EAPI int elm_index_item_level_get(const Eo *obj);
 ...
 */
EAPI void elm_index_level_go(Eo *obj, int level);
 ...
 */
EAPI Elm_Object_Item *elm_index_item_prepend(Eo *obj, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 *
 */
EAPI void elm_index_item_clear(Eo *obj);
 ...
 * @param[in] data The item data to set for the index's item
 */
EAPI Elm_Object_Item *elm_index_item_insert_after(Eo *obj, Elm_Object_Item *after, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 */
EAPI Elm_Object_Item *elm_index_item_find(Eo *obj, const void *data);
 ...
 * @param[in] data The item data to set for the index's item
 */
EAPI Elm_Object_Item *elm_index_item_insert_before(Eo *obj, Elm_Object_Item *before, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @param[in] data The item data to set for the index's item
 */
EAPI Elm_Object_Item *elm_index_item_append(Eo *obj, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @param[in] level @c 0 or @c 1, the currently implemented levels.
 */
EAPI Elm_Object_Item *elm_index_selected_item_get(const Eo *obj, int level);
 ...
 */
EAPI Elm_Object_Item *elm_index_item_sorted_insert(Eo *obj, const char *letter, Evas_Smart_Cb func, const void *data, Eina_Compare_Cb cmp_func, Eina_Compare_Cb cmp_data_func);
