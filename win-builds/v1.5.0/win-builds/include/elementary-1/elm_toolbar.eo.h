...
const Eo_Class *elm_toolbar_class_get(void) EINA_CONST;
...
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_SCROLL;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_SCROLL_ANIM_START;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_SCROLL_ANIM_STOP;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_SCROLL_DRAG_START;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_SCROLL_DRAG_STOP;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_CLICKED;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_SELECTED;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_UNSELECTED;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_LONGPRESSED;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_CLICKED_DOUBLE;
...
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_FOCUSED;
EOAPI extern const Eo_Event_Description _ELM_TOOLBAR_EVENT_UNFOCUSED;

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_SCROLL (&(_ELM_TOOLBAR_EVENT_SCROLL))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_SCROLL_ANIM_START (&(_ELM_TOOLBAR_EVENT_SCROLL_ANIM_START))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_SCROLL_ANIM_STOP (&(_ELM_TOOLBAR_EVENT_SCROLL_ANIM_STOP))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_SCROLL_DRAG_START (&(_ELM_TOOLBAR_EVENT_SCROLL_DRAG_START))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_SCROLL_DRAG_STOP (&(_ELM_TOOLBAR_EVENT_SCROLL_DRAG_STOP))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_CLICKED (&(_ELM_TOOLBAR_EVENT_CLICKED))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_SELECTED (&(_ELM_TOOLBAR_EVENT_SELECTED))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_UNSELECTED (&(_ELM_TOOLBAR_EVENT_UNSELECTED))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_LONGPRESSED (&(_ELM_TOOLBAR_EVENT_LONGPRESSED))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_CLICKED_DOUBLE (&(_ELM_TOOLBAR_EVENT_CLICKED_DOUBLE))
 ...
 * No description
 */
#define ELM_TOOLBAR_EVENT_FOCUSED (&(_ELM_TOOLBAR_EVENT_FOCUSED))

/**
 * No description
 */
#define ELM_TOOLBAR_EVENT_UNFOCUSED (&(_ELM_TOOLBAR_EVENT_UNFOCUSED))
