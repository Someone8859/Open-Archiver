 ...
 */
EAPI void elm_spinner_min_max_set(Eo *obj, double min, double max);
 ...
 */
EAPI void elm_spinner_min_max_get(const Eo *obj, double *min, double *max);
 ...
 */
EAPI void elm_spinner_step_set(Eo *obj, double step);
 ...
 *
 */
EAPI double elm_spinner_step_get(const Eo *obj);
...
disable it.
 */
EAPI void elm_spinner_wrap_set(Eo *obj, Eina_Bool wrap);
 ...
 *
 */
EAPI Eina_Bool elm_spinner_wrap_get(const Eo *obj);
 ...
 */
EAPI void elm_spinner_interval_set(Eo *obj, double interval);
 ...
 *
 */
EAPI double elm_spinner_interval_get(const Eo *obj);
 ...
 */
EAPI void elm_spinner_round_set(Eo *obj, int rnd);
 ...
 *
 */
EAPI int elm_spinner_round_get(const Eo *obj);
 ...
 */
EAPI void elm_spinner_editable_set(Eo *obj, Eina_Bool editable);
 ...
 *
 */
EAPI Eina_Bool elm_spinner_editable_get(const Eo *obj);
 ...
 */
EAPI void elm_spinner_base_set(Eo *obj, double base);
 ...
 *
 */
EAPI double elm_spinner_base_get(const Eo *obj);
 ...
 */
EAPI void elm_spinner_value_set(Eo *obj, double val);
 ...
 *
 */
EAPI double elm_spinner_value_get(const Eo *obj);
 ...
 */
EAPI void elm_spinner_label_format_set(Eo *obj, const char *fmt);
 ...
 *
 */
EAPI const char *elm_spinner_label_format_get(const Eo *obj);
 ...
 */
EAPI void elm_spinner_special_value_add(Eo *obj, double value, const char *label);
