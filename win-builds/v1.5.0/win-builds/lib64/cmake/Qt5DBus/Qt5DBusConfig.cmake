...
set(Qt5DBus_VERSION_STRING 5.3.1)
...
macro(_populate_DBus_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5DBus_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/qt5/QtDBus/5.3.1"
        "${_qt5DBus_install_prefix}/include/qt5/QtDBus/5.3.1/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.1 ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5DBus_install_prefix}/lib64/libQt5DBusd.dll.a" )
