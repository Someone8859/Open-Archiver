...
macro(_populate_Svg_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Svg_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Svg)
    ...
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/qt5/QtSvg/5.3.1"
        "${_qt5Svg_install_prefix}/include/qt5/QtSvg/5.3.1/QtSvg"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Svg_install_prefix}/lib64/libQt5Svgd.dll.a" )
