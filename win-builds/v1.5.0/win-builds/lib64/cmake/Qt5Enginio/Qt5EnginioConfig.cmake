...
macro(_populate_Enginio_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Enginio_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Enginio)
    ...
    set(Qt5Enginio_PRIVATE_INCLUDE_DIRS
        "${_qt5Enginio_install_prefix}/include/qt5/Enginio/1.0.5"
        "${_qt5Enginio_install_prefix}/include/qt5/Enginio/1.0.5/Enginio"
    )
    ...
    _populate_Enginio_target_properties(RELEASE "Qt1Enginio.dll" "libQt1Enginio.dll.a" )

    if (EXISTS
        "${_qt5Enginio_install_prefix}/bin/Qt1Enginiod.dll"
      AND EXISTS
        "${_qt5Enginio_install_prefix}/lib64/libQt1Enginiod.dll.a" )
        _populate_Enginio_target_properties(DEBUG "Qt1Enginiod.dll" "libQt1Enginiod.dll.a" )
    endif()
