...
macro(_populate_Sensors_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Sensors_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Sensors)
    ...
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/qt5/QtSensors/5.3.1"
        "${_qt5Sensors_install_prefix}/include/qt5/QtSensors/5.3.1/QtSensors"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Sensors_install_prefix}/lib64/libQt5Sensorsd.dll.a" )
