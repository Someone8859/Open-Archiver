...
macro(_populate_Quick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Quick_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Quick)
    ...
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/include/qt5/QtQuick/5.3.1"
        "${_qt5Quick_install_prefix}/include/qt5/QtQuick/5.3.1/QtQuick"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Quick_install_prefix}/lib64/libQt5Quickd.dll.a" )
