...
macro(_populate_Test_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Test_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/qt5/QtTest/5.3.1"
        "${_qt5Test_install_prefix}/include/qt5/QtTest/5.3.1/QtTest"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Test_install_prefix}/lib64/libQt5Testd.dll.a" )
