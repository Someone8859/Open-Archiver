...
macro(_populate_XmlPatterns_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5XmlPatterns_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    set(Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS
        "${_qt5XmlPatterns_install_prefix}/include/qt5/QtXmlPatterns/5.3.1"
        "${_qt5XmlPatterns_install_prefix}/include/qt5/QtXmlPatterns/5.3.1/QtXmlPatterns"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5XmlPatterns_install_prefix}/lib64/libQt5XmlPatternsd.dll.a" )
