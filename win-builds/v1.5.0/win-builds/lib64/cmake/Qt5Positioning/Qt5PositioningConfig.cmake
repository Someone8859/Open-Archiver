...
macro(_populate_Positioning_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Positioning_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Positioning)
    ...
    set(Qt5Positioning_PRIVATE_INCLUDE_DIRS
        "${_qt5Positioning_install_prefix}/include/qt5/QtPositioning/5.3.1"
        "${_qt5Positioning_install_prefix}/include/qt5/QtPositioning/5.3.1/QtPositioning"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Positioning_install_prefix}/lib64/libQt5Positioningd.dll.a" )
