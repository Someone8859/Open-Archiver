...
macro(_populate_Nfc_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Nfc_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Nfc)
    ...
    set(Qt5Nfc_PRIVATE_INCLUDE_DIRS
        "${_qt5Nfc_install_prefix}/include/qt5/QtNfc/5.3.1"
        "${_qt5Nfc_install_prefix}/include/qt5/QtNfc/5.3.1/QtNfc"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Nfc_install_prefix}/lib64/libQt5Nfcd.dll.a" )
