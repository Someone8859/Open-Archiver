...
macro(_populate_WebSockets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5WebSockets_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::WebSockets)
    ...
    set(Qt5WebSockets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebSockets_install_prefix}/include/qt5/QtWebSockets/5.3.1"
        "${_qt5WebSockets_install_prefix}/include/qt5/QtWebSockets/5.3.1/QtWebSockets"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5WebSockets_install_prefix}/lib64/libQt5WebSocketsd.dll.a" )
