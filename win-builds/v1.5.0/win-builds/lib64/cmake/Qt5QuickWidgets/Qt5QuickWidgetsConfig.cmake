...
macro(_populate_QuickWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5QuickWidgets_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/qt5/QtQuickWidgets/5.3.1"
        "${_qt5QuickWidgets_install_prefix}/include/qt5/QtQuickWidgets/5.3.1/QtQuickWidgets"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5QuickWidgets_install_prefix}/lib64/libQt5QuickWidgetsd.dll.a" )
