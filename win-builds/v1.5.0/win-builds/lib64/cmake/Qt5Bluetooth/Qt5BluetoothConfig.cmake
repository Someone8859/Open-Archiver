...
macro(_populate_Bluetooth_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Bluetooth_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/qt5/QtBluetooth/5.3.1"
        "${_qt5Bluetooth_install_prefix}/include/qt5/QtBluetooth/5.3.1/QtBluetooth"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Bluetooth_install_prefix}/lib64/libQt5Bluetoothd.dll.a" )
