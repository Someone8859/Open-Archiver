...
macro(_populate_OpenGL_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5OpenGL_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.3.1"
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.3.1/QtOpenGL"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5OpenGL_install_prefix}/lib64/libQt5OpenGLd.dll.a" )
