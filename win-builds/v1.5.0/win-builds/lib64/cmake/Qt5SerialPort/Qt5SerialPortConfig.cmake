...
macro(_populate_SerialPort_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5SerialPort_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::SerialPort)
    ...
    set(Qt5SerialPort_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialPort_install_prefix}/include/qt5/QtSerialPort/5.3.1"
        "${_qt5SerialPort_install_prefix}/include/qt5/QtSerialPort/5.3.1/QtSerialPort"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5SerialPort_install_prefix}/lib64/libQt5SerialPortd.dll.a" )
