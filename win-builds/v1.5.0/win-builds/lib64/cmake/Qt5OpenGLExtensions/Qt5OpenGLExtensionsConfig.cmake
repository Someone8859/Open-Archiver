...
macro(_populate_OpenGLExtensions_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5OpenGLExtensions_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    if (EXISTS "${_qt5OpenGLExtensions_install_prefix}/lib64/libQt5OpenGLExtensionsd.a" )
