...
macro(_populate_Qml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Qml_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Qml)
    ...
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/qt5/QtQml/5.3.1"
        "${_qt5Qml_install_prefix}/include/qt5/QtQml/5.3.1/QtQml"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Qml_install_prefix}/lib64/libQt5Qmld.dll.a" )
