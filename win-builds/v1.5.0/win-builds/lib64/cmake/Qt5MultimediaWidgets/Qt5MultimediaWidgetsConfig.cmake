...
macro(_populate_MultimediaWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5MultimediaWidgets_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    set(Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaWidgets_install_prefix}/include/qt5/QtMultimediaWidgets/5.3.1"
        "${_qt5MultimediaWidgets_install_prefix}/include/qt5/QtMultimediaWidgets/5.3.1/QtMultimediaWidgets"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/lib64/libQt5MultimediaWidgetsd.dll.a" )
