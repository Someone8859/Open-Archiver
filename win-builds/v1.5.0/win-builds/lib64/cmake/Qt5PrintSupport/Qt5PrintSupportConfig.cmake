...
macro(_populate_PrintSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5PrintSupport_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    set(Qt5PrintSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PrintSupport_install_prefix}/include/qt5/QtPrintSupport/5.3.1"
        "${_qt5PrintSupport_install_prefix}/include/qt5/QtPrintSupport/5.3.1/QtPrintSupport"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5PrintSupport_install_prefix}/lib64/libQt5PrintSupportd.dll.a" )
