...
macro(_populate_Help_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Help_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Help)
    ...
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/include/qt5/QtHelp/5.3.1"
        "${_qt5Help_install_prefix}/include/qt5/QtHelp/5.3.1/QtHelp"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Help_install_prefix}/lib64/libQt5Helpd.dll.a" )
