...
macro(_populate_Script_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Script_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Script)
    ...
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.3.1"
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.3.1/QtScript"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Script_install_prefix}/lib64/libQt5Scriptd.dll.a" )
