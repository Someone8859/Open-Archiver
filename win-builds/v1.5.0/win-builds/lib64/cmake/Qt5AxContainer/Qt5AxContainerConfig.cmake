...
set(Qt5AxContainer_VERSION_STRING 5.3.1)
...
macro(_populate_AxContainer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5AxContainer_install_prefix}/lib64/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5AxContainer_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::AxContainer)
    ...
    foreach(_module_dep ${_Qt5AxContainer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.1 ${_Qt5AxContainer_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5AxContainer_install_prefix}/lib64/libQt5AxContainerd.a" )
