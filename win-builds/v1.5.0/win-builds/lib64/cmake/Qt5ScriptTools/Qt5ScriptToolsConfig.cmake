...
macro(_populate_ScriptTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5ScriptTools_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::ScriptTools)
    ...
    set(Qt5ScriptTools_PRIVATE_INCLUDE_DIRS
        "${_qt5ScriptTools_install_prefix}/include/qt5/QtScriptTools/5.3.1"
        "${_qt5ScriptTools_install_prefix}/include/qt5/QtScriptTools/5.3.1/QtScriptTools"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5ScriptTools_install_prefix}/lib64/libQt5ScriptToolsd.dll.a" )
