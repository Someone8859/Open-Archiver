...
macro(_populate_Sql_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Sql_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/qt5/QtSql/5.3.1"
        "${_qt5Sql_install_prefix}/include/qt5/QtSql/5.3.1/QtSql"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Sql_install_prefix}/lib64/libQt5Sqld.dll.a" )
