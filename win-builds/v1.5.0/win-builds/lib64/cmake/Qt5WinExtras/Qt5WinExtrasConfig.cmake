...
set(Qt5WinExtras_VERSION_STRING 5.3.1)
...
macro(_populate_WinExtras_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5WinExtras_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::WinExtras)
    ...
    set(Qt5WinExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5WinExtras_install_prefix}/include/qt5/QtWinExtras/5.3.1"
        "${_qt5WinExtras_install_prefix}/include/qt5/QtWinExtras/5.3.1/QtWinExtras"
    )
    ...
    foreach(_module_dep ${_Qt5WinExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.1 ${_Qt5WinExtras_FIND_VERSION_EXACT}
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5WinExtras_install_prefix}/lib64/libQt5WinExtrasd.dll.a" )
