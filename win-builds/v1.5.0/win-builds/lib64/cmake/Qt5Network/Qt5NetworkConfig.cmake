...
macro(_populate_Network_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Network_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/qt5/QtNetwork/5.3.1"
        "${_qt5Network_install_prefix}/include/qt5/QtNetwork/5.3.1/QtNetwork"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Network_install_prefix}/lib64/libQt5Networkd.dll.a" )
