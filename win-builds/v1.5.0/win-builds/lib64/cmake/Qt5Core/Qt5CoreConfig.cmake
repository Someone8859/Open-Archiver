...
macro(_populate_Core_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Core_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.3.1"
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.3.1/QtCore"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Core_install_prefix}/lib64/libQt5Cored.dll.a" )
