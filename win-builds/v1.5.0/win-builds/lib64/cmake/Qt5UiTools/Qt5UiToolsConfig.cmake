...
macro(_populate_UiTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5UiTools_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::UiTools)
    ...
    set(Qt5UiTools_PRIVATE_INCLUDE_DIRS
        "${_qt5UiTools_install_prefix}/include/qt5/QtUiTools/5.3.1"
        "${_qt5UiTools_install_prefix}/include/qt5/QtUiTools/5.3.1/QtUiTools"
    )
    ...
    if (EXISTS "${_qt5UiTools_install_prefix}/lib64/libQt5UiToolsd.a" )
