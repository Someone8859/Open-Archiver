...
macro(_populate_Multimedia_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5Multimedia_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/qt5/QtMultimedia/5.3.1"
        "${_qt5Multimedia_install_prefix}/include/qt5/QtMultimedia/5.3.1/QtMultimedia"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5Multimedia_install_prefix}/lib64/libQt5Multimediad.dll.a" )
