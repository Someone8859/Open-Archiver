...
set(Qt5AxServer_VERSION_STRING 5.3.1)
...
macro(_populate_AxServer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5AxServer_install_prefix}/lib64/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5AxServer_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::AxServer)
    ...
    foreach(_module_dep ${_Qt5AxServer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.1 ${_Qt5AxServer_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5AxServer_install_prefix}/lib64/libQt5AxServerd.a" )
