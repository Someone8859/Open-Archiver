...
macro(_populate_QuickTest_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_implib "${_qt5QuickTest_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.3.1"
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.3.1/QtQuickTest"
    )
    ...
    if (EXISTS
      ...
      AND EXISTS
        "${_qt5QuickTest_install_prefix}/lib64/libQt5QuickTestd.dll.a" )
