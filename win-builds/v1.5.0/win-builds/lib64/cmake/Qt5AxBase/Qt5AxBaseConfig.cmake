...
set(Qt5AxBase_VERSION_STRING 5.3.1)
...
macro(_populate_AxBase_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5AxBase_install_prefix}/lib64/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5AxBase_install_prefix}/lib64/${IMPLIB_LOCATION}")
...
if (NOT TARGET Qt5::AxBase)
    ...
    set(Qt5AxBase_PRIVATE_INCLUDE_DIRS
        "${_qt5AxBase_install_prefix}/include/qt5/ActiveQt/5.3.1"
        "${_qt5AxBase_install_prefix}/include/qt5/ActiveQt/5.3.1/ActiveQt"
    )
    ...
    foreach(_module_dep ${_Qt5AxBase_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.1 ${_Qt5AxBase_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5AxBase_install_prefix}/lib64/libQt5AxBased.a" )
